...
본 디렉터리(`lr_user-frontend/`)는 사용자용 프론트엔드(React + Vite, dev: `http://localhost:5173/`)다.
...
- API 호출 일관성: `api-endpoints`
- 서비스 재시작 (직접 `npm run dev` 금지): `service-restart` 또는 `./restart-user-frontend.sh --bf`
